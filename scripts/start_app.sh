...
update_env_var "/mybalance/${ENV_SUFFIX}/MERCHANT_DASHBOARD_BASE_URL" "MERCHANT_DASHBOARD_BASE_URL"

update_env_var "/mybalance/${ENV_SUFFIX}/MERCHANT_REDIRECT_BASE_URL" "MERCHANT_REDIRECT_BASE_URL"
update_env_var "/mybalance/${ENV_SUFFIX}/CUSTOMER_WIDGET_BASE_URL" "CUSTOMER_WIDGET_BASE_URL"
