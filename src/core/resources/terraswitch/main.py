...
class TerraSwitchService(TerraSwitchBaseService):
    ...
    def initiate_bank_transfer(cls, data):
        url = f"{cls.TERRASWITCH_BASE_URL}/charges?type=bank_transfer"
    ...
    def initiate_payout(cls, data):
        url = f"{cls.TERRASWITCH_BASE_URL}/transfers"
        return cls.make_post_request(
            url, data, camelize=False, terraswitch_headers=cls.TERRASWITCH_HEADERS
        )
    ...
    def initiate_payment_link(cls, data):
        url = f"{cls.TERRASWITCH_BASE_URL}/payments"
        return cls.make_post_request(
            url, data, camelize=False, terraswitch_headers=cls.TERRASWITCH_HEADERS
        )
    ...
    def verify_transaction(cls, transaction_id):
        url = f"{cls.TERRASWITCH_BASE_URL}/transactions/{transaction_id}/verify"
