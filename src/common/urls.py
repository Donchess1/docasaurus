...
urlpatterns = [
    ...
    path("lookup/nuban", ValidateBankAccountView.as_view(), name="validate-bank-account"),
    path("lookup/email", ValidateEmailAddressView.as_view(), name="validate-email-address",),
    path("fund-wallet", FundWalletView.as_view(), name="fund-wallet"),
    path("initiate-product-payment", GenerateProductPaymentLinkView.as_view(), name="product-payment-link",),
    path("ticket-analytics", TicketPurchaseAnalyticsView.as_view(), name="product-ticket-analytics",),
    path("fund-wallet-stripe", FundWalletStripeView.as_view(), name="fund-wallet-stripe"),
    path("fund-wallet-terraswitch", FundWalletTerraSwitchView.as_view(), name="fund-wallet-terraswitch",),
    path("payment-redirect", FundWalletRedirectView.as_view(), name="fund-wallet-redirect",),
    path("escrow-payment-redirect", FundEscrowTransactionRedirectView.as_view(), name="fund-escrow-redirect",),
    path("product-payment-redirect", ProductPaymentTransactionRedirectView.as_view(), name="fund-escrow-redirect",),
    path("withdrawal-fee", WalletWithdrawalFeeView.as_view(), name="withdrawal-fee"),
    path("trim-merchant-token", TrimMerchantTokenView.as_view(), name="trim-merchant-token",),
    path("withdraw", WalletWithdrawalView.as_view(), name="withdraw-funds"),
    path("withdraw-callback", WalletWithdrawalCallbackView.as_view(), name="withdraw-funds-callback",),
    path("upload", UploadMediaView.as_view(), name="upload-media"),
    path("flw-webhook", FlwWebhookView.as_view(), name="flw-webhook",),
    path("stripe-webhook", StripeWebhookView.as_view(), name="stripe-webhook",),
    path("terraswitch-webhook", TerraSwitchWebhookView.as_view(), name="terraswitch-webhook",),
    path("terraswitch", TestTerraSwitchAPIView.as_view(), name="test-terraswitch",),
]
# fmt: on
