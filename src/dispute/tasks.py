...
def send_dispute_raised_via_merchant_widget_author_email(email, values):
    EmailClientV2.send_dispute_raised_via_merchant_widget_author_email(email, values)
...
def send_dispute_raised_via_merchant_widget_receiver_email(email, values):
    EmailClientV2.send_dispute_raised_via_merchant_widget_receiver_email(email, values)
